...
const authMiddleware = require('./auth-middleware-1');

const app = express();
app.use(bodyParser.json());

// Esta rota não passa pelo middleware de autenticação!
// é importante destacar que o app.use só afeta as rotas que vem abaixo da sua definição. 
//Ou seja, todas as rotas do nosso CRUD de receitas vão passar pelo middleware de autenticação,
// enquanto a rota /open não vai
// em todos os enderecos abaixo do app.use, vai ser verificado a senha e o usuario
