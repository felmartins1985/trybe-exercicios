...
app.put('/drinks/:id', function(req,res){
  ...
  if(drinkIndex===-1) return res.status(404).json({message:'Drink nao encontrado'});
  drinks[drinkIndex]={...drinks[drinkIndex],name, price};
  res.status(204).end();
  //o end() indica que a resposta vai ser retornada sem  nenhuma informação.
})
// para deletar
...
//
app.all('*', function (req, res) {// deve ser sempre a última definição de rota da API
