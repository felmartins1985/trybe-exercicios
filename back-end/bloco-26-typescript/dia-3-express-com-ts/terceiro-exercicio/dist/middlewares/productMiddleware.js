...
function validateDates(manufacturingDate, expirationDate) {
...
function validateBrandAndPrice(brand, price) {
...
function validateBody(req, res, next) {
    const { name, brand, expirationDate, manufacturingDate, price } = req.body;
